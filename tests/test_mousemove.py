...
class TestFormatMoveLog:
    def test_contains_timestamp(self):
        ...
        result = format_move_log(
            "01:23:45 PM", MagicMock(x=0, y=0), MagicMock(x=0, y=0)
        )
    ...
    def test_contains_start_x(self):
        ...
        result = format_move_log(
            "12:00:00 PM", MagicMock(x=111, y=0), MagicMock(x=0, y=0)
        )
    ...
    def test_contains_start_y(self):
        ...
        result = format_move_log(
            "12:00:00 PM", MagicMock(x=0, y=222), MagicMock(x=0, y=0)
        )
    ...
    def test_contains_end_x(self):
        ...
        result = format_move_log(
            "12:00:00 PM", MagicMock(x=0, y=0), MagicMock(x=333, y=0)
        )
    ...
    def test_contains_end_y(self):
        ...
        result = format_move_log(
            "12:00:00 PM", MagicMock(x=0, y=0), MagicMock(x=0, y=444)
        )
    ...
    def test_contains_unicode_arrow(self):
        ...
        result = format_move_log(
            "12:00:00 PM", MagicMock(x=0, y=0), MagicMock(x=0, y=0)
        )
        assert "→" in result
...
class TestMoveLoop:
    ...
    def test_log_shows_start_position(self, capsys):
        ...
        with patch("mousemove.pyautogui") as mock_pg, patch(
            "mousemove.time.sleep", side_effect=KeyboardInterrupt
        ):
            mock_pg.size.return_value = (1920, 1080)
